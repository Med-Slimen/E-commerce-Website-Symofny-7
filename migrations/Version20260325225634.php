 ...
 */
final class Version20260325225634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_products (id INT AUTO_INCREMENT NOT NULL, qte INT NOT NULL, _order_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_5242B8EBA35F2858 (_order_id), INDEX IDX_5242B8EB4584665A (product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
